          ...
          <form onSubmit={handleCreateQuestion} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-xl border border-white/[0.06] bg-white/[0.03] px-4 py-3 text-gray-100 outline-none transition-all duration-300 focus:border-violet-500/50 focus:ring-2 focus:ring-violet-500/10 focus:bg-white/[0.05] backdrop-blur-sm [&>option]:bg-slate-900 [&>option]:text-gray-100"
              >
