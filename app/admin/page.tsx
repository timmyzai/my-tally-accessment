...
import QuestionSetsTab from "./components/QuestionSetsTab";

const tabs = ["Question Sets", "Questions", "Assessments", "Candidates", "Invites", "Results"] as const;
...
export default function AdminDashboard() {
  const [activeTab, setActiveTab] = useState<Tab>("Question Sets");
